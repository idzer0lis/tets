<template>
  <div id="page-styleguide" class="page">
    <div class="container">
                    ...
                    <form class="form-horizontal">
                      <fieldset>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-lg-10">
                            <input class="form-control" id="inputPassword" placeholder="Password" type="password" autocomplete="off">
                            <div class="checkbox">
                              <label>
                  ...
                  <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                      ...
                      <div class="alert alert-success alert-dismissable">
                        ...
                        <i class="fa fa-thumbs-up"></i> <strong>Success!</strong> Indicates a successful or positive action.
                      </div>
                      ...
                      <div class="alert alert-info alert-dismissable">
                        ...
                        <i class="fa fa-info-circle"></i> <strong>Info!</strong> Indicates a neutral informative change or action.
                      </div>
                      ...
                      <div class="alert alert-warning alert-dismissable">
                        ...
                        <i class="fa fa-warning"></i> <strong>Warning!</strong> Indicates a warning that might need attention.
                      </div>
                      ...
                      <div class="alert alert-danger alert-dismissable">
                        ...
                        <i class="fa fa-ban"></i> <strong>Danger!</strong> Indicates a dangerous or potentially negative action.
                      </div>
